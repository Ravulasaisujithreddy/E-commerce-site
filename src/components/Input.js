...
function Input({ setSearch }) {
  ...
  return (
    <div
      className={`flex items-center p-2 w-full max-w-lg mx-auto bg-white shadow-md rounded-full ${
        theme === "light" ? "border-gray-300" : "border-gray-600"
      } border focus-within:ring-2 focus-within:ring-blue-500 transition duration-150`}
    >
      <IoIosSearch
