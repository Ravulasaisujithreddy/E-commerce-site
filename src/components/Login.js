  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center text-black">{loginPage ? "Login" : "Signup"}</h2>

        {error && <p className="text-red-500 text-center">{error}</p>}

        <form onSubmit={loginPage ? handleLogin : handleSignup} className="space-y-6">
          {!loginPage && (
            <div>
